    ...
    def to_pseudocode(self):
        ...
        if not self.code_sections:
            ...
            for section in self.code_sections:
                try:
                    code_data = section.get_data()
                    pseudocode_output += f"Pseudocode for section {section.Name.decode().strip()}:\n"
                    for instruction in self.disassembler.disasm(code_data, section.VirtualAddress):
...
class AssemblyHighlighter(QSyntaxHighlighter):
    ...
    def highlightBlock(self, text):
        ...
        while operand_index >= 0:
            ...
            self.setFormat(operand_index + 2, length - 2, self.operand_format)
...
class DisassemblerGUI(QMainWindow):
    ...
    def initUI(self):
        ...
        self.run_button = QPushButton("Run File", self)
    ...
    def toggle_mode(self, state):
        if state == Qt.Checked:
            ...
            self.disassembly_view.setStyleSheet("background-color: #121212; color: white;")
            self.hex_view.setStyleSheet("background-color: #121212; color: white;")
            self.pseudocode_view.setStyleSheet("background-color: #121212; color: white;")
            self.output_view.setStyleSheet("background-color: #121212; color: white;")
            self.functions_view.setStyleSheet("background-color: #121212; color: white;")
            ...
            self.pseudocode_view.setStyleSheet("")
